var je=Object.defineProperty;var Ve=(i,n,e)=>n in i?je(i,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[n]=e;var D=(i,n,e)=>Ve(i,typeof n!="symbol"?n+"":n,e);import{r as j}from"./index-K1G2e5ai.js";import{s as Fe}from"./fileDetector-CroYuvW7.js";function We(i){for(var n=1;n<arguments.length;n++){var e=arguments[n];for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(i[r]=e[r])}return i}function le(i,n){return Array(n+1).join(i)}function Ae(i){return i.replace(/^\n*/,"")}function Se(i){for(var n=i.length;n>0&&i[n-1]===`
`;)n--;return i.substring(0,n)}function ke(i){return Se(Ae(i))}var Xe=["ADDRESS","ARTICLE","ASIDE","AUDIO","BLOCKQUOTE","BODY","CANVAS","CENTER","DD","DIR","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","FRAMESET","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","HTML","ISINDEX","LI","MAIN","MENU","NAV","NOFRAMES","NOSCRIPT","OL","OUTPUT","P","PRE","SECTION","TABLE","TBODY","TD","TFOOT","TH","THEAD","TR","UL"];function ce(i){return ue(i,Xe)}var Ce=["AREA","BASE","BR","COL","COMMAND","EMBED","HR","IMG","INPUT","KEYGEN","LINK","META","PARAM","SOURCE","TRACK","WBR"];function Le(i){return ue(i,Ce)}function ze(i){return Ie(i,Ce)}var De=["A","TABLE","THEAD","TBODY","TFOOT","TH","TD","IFRAME","SCRIPT","AUDIO","VIDEO"];function qe(i){return ue(i,De)}function Ye(i){return Ie(i,De)}function ue(i,n){return n.indexOf(i.nodeName)>=0}function Ie(i,n){return i.getElementsByTagName&&n.some(function(e){return i.getElementsByTagName(e).length})}var Ke=[[/\\/g,"\\\\"],[/\*/g,"\\*"],[/^-/g,"\\-"],[/^\+ /g,"\\+ "],[/^(=+)/g,"\\$1"],[/^(#{1,6}) /g,"\\$1 "],[/`/g,"\\`"],[/^~~~/g,"\\~~~"],[/\[/g,"\\["],[/\]/g,"\\]"],[/^>/g,"\\>"],[/_/g,"\\_"],[/^(\d+)\. /g,"$1\\. "]];function Re(i){return Ke.reduce(function(n,e){return n.replace(e[0],e[1])},i)}var k={};k.paragraph={filter:"p",replacement:function(i){return`
...
`):""}function he(i){var n=i.replace(/([<>()])/g,"\\$1");return n.indexOf(" ")>=0?"<"+n+">":n}function de(i){return i.replace(/"/g,'\\"')}function Pe(i){this.options=i,this._keep=[],this._remove=[],this.blankRule={replacement:i.blankReplacement},this.keepReplacement=i.keepReplacement,this.defaultRule={replacement:i.defaultReplacement},this.array=[];for(var n in i.rules)this.array.push(i.rules[n])}Pe.prototype={add:function(i,n){this.array.unshift(n)},keep:function(i){this._keep.unshift({filter:i,replacement:this.keepReplacement})},remove:function(i){this._remove.unshift({filter:i,replacement:function(){return""}})},forNode:function(i){if(i.isBlank)return this.blankRule;var n;return(n=ae(this.array,i,this.options))||(n=ae(this._keep,i,this.options))||(n=ae(this._remove,i,this.options))?n:this.defaultRule},forEach:function(i){for(var n=0;n<this.array.length;n++)i(this.array[n],n)}};function ae(i,n,e){for(var r=0;r<i.length;r++){var t=i[r];if(Je(t,n,e))return t}}function Je(i,n,e){var r=i.filter;if(typeof r=="string"){if(r===n.nodeName.toLowerCase())return!0}else if(Array.isArray(r)){if(r.indexOf(n.nodeName.toLowerCase())>-1)return!0}else if(typeof r=="function"){if(r.call(i,n,e))return!0}else throw new TypeError("`filter` needs to be a string, array, or function")}function Qe(i){var n=i.element,e=i.isBlock,r=i.isVoid,t=i.isPre||function(u){return u.nodeName==="PRE"};if(!(!n.firstChild||t(n))){for(var a=null,o=!1,s=null,l=Te(s,n,t);l!==n;){if(l.nodeType===3||l.nodeType===4){var c=l.data.replace(/[ \r\n\t]+/g," ");if((!a||/ $/.test(a.data))&&!o&&c[0]===" "&&(c=c.substr(1)),!c){l=se(l);continue}l.data=c,a=l}else if(l.nodeType===1)e(l)||l.nodeName==="BR"?(a&&(a.data=a.data.replace(/ $/,"")),a=null,o=!1):r(l)||t(l)?(a=null,o=!0):a&&(o=!1);else{l=se(l);continue}var h=Te(s,l,t);s=l,l=h}a&&(a.data=a.data.replace(/ $/,""),a.data||se(a))}}function se(i){var n=i.nextSibling||i.parentNode;return i.parentNode.removeChild(i),n}function Te(i,n,e){return i&&i.parentNode===n||e(n)?n.nextSibling||n.parentNode:n.firstChild||n.nextSibling||n.parentNode}var fe=typeof window<"u"?window:{};function Ze(){var i=fe.DOMParser,n=!1;try{new i().parseFromString("","text/html")&&(n=!0)}catch{}return n}function et(){var i=function(){};return tt()?i.prototype.parseFromString=function(n){var e=new window.ActiveXObject("htmlfile");return e.designMode="on",e.open(),e.write(n),e.close(),e}:i.prototype.parseFromString=function(n){var e=document.implementation.createHTMLDocument("");return e.open(),e.write(n),e.close(),e},i}function tt(){var i=!1;try{document.implementation.createHTMLDocument("").open()}catch{fe.ActiveXObject&&(i=!0)}return i}var rt=Ze()?fe.DOMParser:et();function it(i,n){var e;if(typeof i=="string"){var r=nt().parseFromString('<x-turndown id="turndown-root">'+i+"</x-turndown>","text/html");e=r.getElementById("turndown-root")}else e=i.cloneNode(!0);return Qe({element:e,isBlock:ce,isVoid:Le,isPre:n.preformattedCode?at:null}),e}var oe;function nt(){return oe=oe||new rt,oe}function at(i){return i.nodeName==="PRE"||i.nodeName==="CODE"}function st(i,n){return i.isBlock=ce(i),i.isCode=i.nodeName==="CODE"||i.parentNode.isCode,i.isBlank=ot(i),i.flankingWhitespace=lt(i,n),i}function ot(i){return!Le(i)&&!qe(i)&&/^\s*$/i.test(i.textContent)&&!ze(i)&&!Ye(i)}function lt(i,n){if(i.isBlock||n.preformattedCode&&i.isCode)return{leading:"",trailing:""};var e=ct(i.textContent);return e.leadingAscii&&Ne("left",i,n)&&(e.leading=e.leadingNonAscii),e.trailingAscii&&Ne("right",i,n)&&(e.trailing=e.trailingNonAscii),{leading:e.leading,trailing:e.trailing}}function ct(i){var n=i.match(/^(([ \t\r\n]*)(\s*))(?:(?=\S)[\s\S]*\S)?((\s*?)([ \t\r\n]*))$/);return{leading:n[1],leadingAscii:n[2],leadingNonAscii:n[3],trailing:n[4],trailingNonAscii:n[5],trailingAscii:n[6]}}function Ne(i,n,e){var r,t,a;return i==="left"?(r=n.previousSibling,t=/ $/):(r=n.nextSibling,t=/^ /),r&&(r.nodeType===3?a=t.test(r.nodeValue):e.preformattedCode&&r.nodeName==="CODE"?a=!1:r.nodeType===1&&!ce(r)&&(a=t.test(r.textContent))),a}var ut=Array.prototype.reduce;function Q(i){if(!(this instanceof Q))return new Q(i);var n={rules:k,headingStyle:"setext",hr:"* * *",bulletListMarker:"*",codeBlockStyle:"indented",fence:"```",emDelimiter:"_",strongDelimiter:"**",linkStyle:"inlined",linkReferenceStyle:"full",br:"  ",preformattedCode:!1,blankReplacement:function(e,r){return r.isBlock?`
...
`:e}};this.options=We({},n,i),this.rules=new Pe(this.options)}Q.prototype={turndown:function(i){if(!ft(i))throw new TypeError(i+" is not a string, or an element/document/fragment node.");if(i==="")return"";var n=$e.call(this,new it(i,this.options));return ht.call(this,n)},use:function(i){if(Array.isArray(i))for(var n=0;n<i.length;n++)this.use(i[n]);else if(typeof i=="function")i(this);else throw new TypeError("plugin must be a Function or an Array of Functions");return this},addRule:function(i,n){return this.rules.add(i,n),this},keep:function(i){return this.rules.keep(i),this},remove:function(i){return this.rules.remove(i),this},escape:function(i){return Re(i)}};function $e(i){var n=this;return ut.call(i.childNodes,function(e,r){r=new st(r,n.options);var t="";return r.nodeType===3?t=r.isCode?r.nodeValue:n.escape(r.nodeValue):r.nodeType===1&&(t=dt.call(n,r)),Me(e,t)},"")}function ht(i){var n=this;return this.rules.forEach(function(e){typeof e.append=="function"&&(i=Me(i,e.append(n.options)))}),i.replace(/^[\t\r\n]+/,"").replace(/[\t\r\n\s]+$/,"")}function dt(i){var n=this.rules.forNode(i),e=$e.call(this,i),r=i.flankingWhitespace;return(r.leading||r.trailing)&&(e=e.trim()),r.leading+n.replacement(e,i,this.options)+r.trailing}function Me(i,n){var e=Se(i),r=Ae(n),t=Math.max(i.length-e.length,n.length-r.length),a=`

`.substring(0,t);return e+a+r}function ft(i){return i!=null&&(typeof i=="string"||i.nodeType&&(i.nodeType===1||i.nodeType===9||i.nodeType===11))}var we=/highlight-(?:text|source)-([a-z0-9]+)/;function mt(i){i.addRule("highlightedCodeBlock",{filter:function(n){var e=n.firstChild;return n.nodeName==="DIV"&&we.test(n.className)&&e&&e.nodeName==="PRE"},replacement:function(n,e,r){var t=e.className||"",a=(t.match(we)||[null,""])[1];return`

`+r.fence+a+`
`+e.firstChild.textContent+`
`+r.fence+`

`}})}function gt(i){i.addRule("strikethrough",{filter:["del","s","strike"],replacement:function(n){return"~"+n+"~"}})}var pt=Array.prototype.indexOf,vt=Array.prototype.every,F={};F.tableCell={filter:["th","td"],replacement:function(i,n){return Be(i,n)}};F.tableRow={filter:"tr",replacement:function(i,n){var e="",r={left:":--",right:"--:",center:":-:"};if(me(n))for(var t=0;t<n.childNodes.length;t++){var a="---",o=(n.childNodes[t].getAttribute("align")||"").toLowerCase();o&&(a=r[o]||a),e+=Be(a,n.childNodes[t])}return`
`+i+(e?`
`+e:"")}};F.table={filter:function(i){return i.nodeName==="TABLE"&&me(i.rows[0])},replacement:function(i){return i=i.replace(`
...
`}};F.tableSection={filter:["thead","tbody","tfoot"],replacement:function(i){return i}};function me(i){var n=i.parentNode;return n.nodeName==="THEAD"||n.firstChild===i&&(n.nodeName==="TABLE"||yt(n))&&vt.call(i.childNodes,function(e){return e.nodeName==="TH"})}function yt(i){var n=i.previousSibling;return i.nodeName==="TBODY"&&(!n||n.nodeName==="THEAD"&&/^\s*$/i.test(n.textContent))}function Be(i,n){var e=pt.call(n.parentNode.childNodes,n),r=" ";return e===0&&(r="| "),r+i+" |"}function bt(i){i.keep(function(e){return e.nodeName==="TABLE"&&!me(e.rows[0])});for(var n in F)i.addRule(n,F[n])}function _t(i){i.addRule("taskListItems",{filter:function(n){return n.type==="checkbox"&&n.parentNode.nodeName==="LI"},replacement:function(n,e){return(e.checked?"[x]":"[ ]")+" "}})}function Et(i){i.use([mt,gt,bt,_t])}const Z=new Q({headingStyle:"atx",hr:"---",bulletListMarker:"-",codeBlockStyle:"fenced",emDelimiter:"*"});Z.use(Et);Z.addRule("detailsRule",{filter:"details",replacement:function(i,n){var a;const r=((a=n.querySelector("summary"))==null?void 0:a.textContent)||"思考过程 (Thinking)",t=i.replace(r,"").trim();return`
...
`}),{title:r,modelName:"DeepSeek-V3 / R1",turns:e,markdown:t}}injectUI(n){this.detectTurns().forEach(r=>{if(r.dataset.dshInjected==="true")return;r.dataset.dshInjected="true";const t=document.createElement("button");t.className="dsh-chat-inject-btn",t.innerHTML=`
      ...
      `,t.title="将此轮对话（提示词 + 思考过程 + 回答）保存至 DSH 知识库",t.onclick=a=>{a.stopPropagation(),a.preventDefault();const o=this.extractTurn(r);o&&(t.innerText="已存入 ✓",setTimeout(()=>{t.innerHTML=`
              ...
              存入 DSH
            `},2500),n(o))},r.style.position="relative",r.prepend(t)})}}class Nt{constructor(){D(this,"id","chatgpt");D(this,"name","ChatGPT")}matches(n){return n.includes("chatgpt.com")||n.includes("chat.openai.com")}detectTurns(){return Array.from(document.querySelectorAll('[data-message-author-role="assistant"]'))}extractTurn(n){var e,r;try{const t=n.querySelector(".markdown")||n,a=O(t.innerHTML).trim();let o="";const s=n.closest('[data-testid^="conversation-turn"]')||n.parentElement,l=s==null?void 0:s.previousElementSibling;if(l){const m=l.querySelector('[data-message-author-role="user"]');m&&(o=((e=m.textContent)==null?void 0:e.trim())||"")}o||(o="ChatGPT 对话提问");let c="";const h=n.querySelector('[data-testid="thought"], div[class*="thought"]');h&&(c=((r=h.textContent)==null?void 0:r.trim())||"");const u=(typeof window<"u"?window.location.href:"")||"https://chatgpt.com";let f=`# 💬 ChatGPT 对话轮次
...
`}),{title:r,modelName:"Claude 3.5 / 3.7",turns:e,markdown:t}}injectUI(n){this.detectTurns().forEach(r=>{if(r.dataset.dshInjected==="true")return;r.dataset.dshInjected="true";const t=document.createElement("button");t.className="dsh-chat-inject-btn",t.innerHTML=`
      ...
      `,t.onclick=a=>{a.stopPropagation(),a.preventDefault();const o=this.extractTurn(r);o&&(t.innerText="已存入 ✓",setTimeout(()=>{t.innerHTML=`
              ...
              存入 DSH
            `},2500),n(o))},r.appendChild(t)})}}class xt{constructor(){D(this,"id","gemini");D(this,"name","Google Gemini")}matches(n){return n.includes("gemini.google.com")}detectTurns(){return Array.from(document.querySelectorAll('model-response, message-content, div[class*="model-response"]'))}extractTurn(n){var e,r;try{const t=O(n.innerHTML).trim();let a="Gemini 提问";const o=(e=n.closest(".conversation-container"))==null?void 0:e.querySelector(".user-query");o&&(a=((r=o.textContent)==null?void 0:r.trim())||a);const s=(typeof window<"u"?window.location.href:"")||"https://gemini.google.com";return{prompt:a,answer:t,modelName:"Google Gemini",markdown:`# ✨ Gemini 对话轮次
...
`}),{title:r,modelName:"Google Gemini",turns:e,markdown:t}}injectUI(n){this.detectTurns().forEach(r=>{if(r.dataset.dshInjected==="true")return;r.dataset.dshInjected="true";const t=document.createElement("button");t.className="dsh-chat-inject-btn",t.innerHTML="存入 DSH",t.onclick=a=>{a.stopPropagation(),a.preventDefault();const o=this.extractTurn(r);o&&(t.innerText="已存入 ✓",setTimeout(()=>{t.innerText="存入 DSH"},2e3),n(o))},r.appendChild(t)})}}class At{constructor(){D(this,"id","doubao");D(this,"name","豆包 (Doubao)")}matches(n){return n.includes("doubao.com")}detectTurns(){return Array.from(document.querySelectorAll('div[class*="assistant-bubble"], div[data-testid="assistant_message"]'))}extractTurn(n){const e=O(n.innerHTML).trim(),r=(typeof window<"u"?window.location.href:"")||"https://www.doubao.com";return{prompt:"豆包对话提问",answer:e,modelName:"Doubao",markdown:`# 🌰 豆包对话轮次
...
---
`)}}injectUI(n){this.detectTurns().forEach(r=>{if(r.dataset.dshInjected==="true")return;r.dataset.dshInjected="true";const t=document.createElement("button");t.className="dsh-chat-inject-btn",t.innerText="存入 DSH",t.onclick=()=>{const a=this.extractTurn(r);a&&n(a)},r.appendChild(t)})}}class St{constructor(){D(this,"id","grok");D(this,"name","xAI Grok")}matches(n){return n.includes("grok.com")||n.includes("x.com/i/grok")}detectTurns(){return Array.from(document.querySelectorAll('div[class*="response-message"], div[data-testid="grok-response"]'))}extractTurn(n){const e=O(n.innerHTML).trim(),r=(typeof window<"u"?window.location.href:"")||"https://grok.com";return{prompt:"Grok 提问",answer:e,modelName:"xAI Grok",markdown:`# ⚡ Grok 对话轮次
...
`;return{title:a,byline:o,excerpt:s,markdown:b+f,rawHtml:l,mediaAttachments:h}}function xe(i){const n=Math.floor(i/60),e=Math.floor(i%60),r=Math.floor(n/60),t=n%60;return r>0?`${r.toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`:`${t.toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`}function Bt(i){return i.includes("bilibili.com/video")?{isVideo:!0,platform:"bilibili"}:i.includes("youtube.com/watch")||i.includes("youtu.be/")?{isVideo:!0,platform:"youtube"}:{isVideo:!1,platform:"other"}}function Ht(i=""){const n=document.querySelector("video"),e=window.location.href,{isVideo:r,platform:t}=Bt(e);if(!r&&!n)return null;const a=n?n.currentTime:0,o=n?n.duration:0,s=xe(a),l=xe(o);let c=e;t==="youtube"?c=`${e.split("&t=")[0]}&t=${Math.floor(a)}s`:t==="bilibili"&&(c=`${e.split("?p=")[0].split("&t=")[0]}?t=${Math.floor(a)}`);const h=document.title||"在线视频调研线索",u=`## 🎬 多模态音视频调研线索
...
`;return{title:`[视频线索] ${h.slice(0,40)}`,url:c,sourcePlatform:t,documentType:"media",tags:["Video",t,"MultimodalCue"],markdownContent:u,userNotes:i}}function Ot(i,n,e,r){chrome.runtime.sendMessage({type:"CAPTURE_VISIBLE_TAB_REQUEST"},t=>{var a;if(chrome.runtime.lastError||!t||!t.success||!t.dataUrl){const o=(t==null?void 0:t.error)||((a=chrome.runtime.lastError)==null?void 0:a.message)||"截取当前可视区域失败";n(o);return}Ut(t.dataUrl,i,e,r)})}function Ut(i,n,e,r){var L;const t=document.getElementById("dsh-cropper-overlay");t&&(t.remove(),(L=window.__dsh_cropper_cleanup)==null||L.call(window));const a=document.createElement("div");a.id="dsh-cropper-overlay",a.style.cssText=`
...
`,y=o&&o.length>0?o:["Screenshots"],N={id:`snap-${T}`,project:a||"",topic:y.join("+"),topics:y,title:`[截图快照] ${R.slice(0,35)}`,url:L,urlType:j(L),sourcePlatform:"web_article",capturedAt:new Date().toISOString(),documentType:"screenshot",tags:["Screenshot","VisualSnapshot","Multimodal",...y],userNotes:e,markdownContent:d,screenshotMetadata:g,mediaAttachments:[{id:`att-snap-${T}`,type:"image",originalUrl:L,filename:C,localPath:`assets/${C}`,blobDataUrl:E}]};r(N,t)},s.onerror=()=>{t({success:!1,error:"截屏图像加载失败，请刷新页面后重试"})},s.src=i}function H(){return window.location.href||document.URL||location.href||"about:blank"}function jt(){const i="dsh-sensor-styles";if(document.getElementById(i))return;const n=document.createElement("style");n.id=i,n.textContent=`
    .dsh-chat-inject-btn {
      display: inline-flex;
      align-items: center;
      gap: 4px;
  ...
  `,document.head.appendChild(n)}function B(i,n=!1){let e=document.getElementById("dsh-toast-root");e||(e=document.createElement("div"),e.id="dsh-toast-root",e.className="dsh-toast-container",document.body.appendChild(e));const r=document.createElement("div");r.className=`dsh-toast ${n?"error":""}`,r.textContent=i,e.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s ease",setTimeout(()=>r.remove(),300)},3500)}function G(i,n){chrome.runtime.sendMessage({type:"SAVE_BUNDLE",payload:i},e=>{var r;if(e&&e.success)B(`✓ 已成功归档至 DSH: ${i.title.slice(0,25)}`),n==null||n({success:!0,savedPath:(r=e.data)==null?void 0:r.savedPath});else{const t=(e==null?void 0:e.error)||"未能成功写入磁盘";B(`✕ 保存失败: ${t}`,!0),n==null||n({success:!1,error:t})}})}let I=null;function Vt(){document.addEventListener("mouseup",()=>{var a;const i=window.getSelection(),n=i==null?void 0:i.toString().trim();if(I&&(I.remove(),I=null),!n||n.length<5)return;const e=(a=i==null?void 0:i.anchorNode)==null?void 0:a.parentElement;if(e!=null&&e.closest('input, textarea, [contenteditable="true"]'))return;const r=i==null?void 0:i.getRangeAt(0);if(!r)return;const t=r.getBoundingClientRect();t.width===0&&t.height===0||(I=document.createElement("div"),I.className="dsh-floating-pill",I.innerHTML=`
      ...
      存入 DSH
    `,I.style.top=`${window.scrollY+t.top-8}px`,I.style.left=`${window.scrollX+t.left+t.width/2-40}px`,I.onmousedown=o=>o.stopPropagation(),I.onclick=o=>{o.stopPropagation();const s=H(),l={id:`snip-${Date.now()}`,project:"",topic:"",title:`摘录: ${n.slice(0,30)}...`,url:s,urlType:j(s),sourcePlatform:"web_article",capturedAt:new Date().toISOString(),documentType:"snippet",tags:["Snippet","Quote"],markdownContent:`> ${n.replace(/\n+/g,`
> `)}

---
> 来源出处: [${document.title||s}](${s})`,mediaAttachments:[]};G(l),I&&(I.remove(),I=null)},document.body.appendChild(I))})}function Ft(){const i=H(),n=He.findAdapter(i);if(!n)return;console.log(`[DSH Sensor] 检测到匹配的 AI Chat 平台: ${n.name}`);const e=t=>{const a=H(),o={id:`chat-${Date.now()}`,project:"",topic:"AI-Chat",title:`${n.name}: ${t.prompt.slice(0,30)}`,url:a,urlType:j(a),sourcePlatform:n.id,capturedAt:new Date().toISOString(),documentType:"chat_turn",tags:["AIChat",n.name,t.modelName||"LLM"],markdownContent:t.markdown,aiMetadata:{modelName:t.modelName,hasThinkingChain:!!t.thinking,thinkingContent:t.thinking,promptContext:t.prompt},mediaAttachments:t.mediaAttachments||[]};G(o)};n.injectUI(e),new MutationObserver(()=>{n.injectUI(e)}).observe(document.body,{childList:!0,subtree:!0})}chrome.runtime.onMessage.addListener((i,n,e)=>{var r;if(i.type==="SHOW_TOAST"){const t=i.payload;B(t.message,t.isError),e({ok:!0})}if(i.type==="CAPTURE_FULL_PAGE"){const t=H();return Mt(document).then(a=>{const o={id:`page-${Date.now()}`,project:"",topic:"",title:a.title,url:t,urlType:j(t),sourcePlatform:"web_article",capturedAt:new Date().toISOString(),documentType:"article",tags:["Article","Research"],markdownContent:a.markdown,mediaAttachments:a.mediaAttachments};G(o),e({success:!0,item:o})}).catch(a=>{B(`提取正文失败: ${a.message}`,!0),e({success:!1,error:a.message})}),!0}if(i.type==="CAPTURE_SELECTION"){const t=i.payload,a=(t==null?void 0:t.text)||((r=window.getSelection())==null?void 0:r.toString())||"";if(a){const o=H(),s={id:`snip-${Date.now()}`,project:"",topic:"",title:`摘录: ${a.slice(0,30)}...`,url:o,urlType:j(o),sourcePlatform:"web_article",capturedAt:new Date().toISOString(),documentType:"snippet",tags:["Snippet","Quote"],markdownContent:`> ${a.replace(/\n+/g,`
> `)}

---
> 来源出处: [${document.title||o}](${o})`,mediaAttachments:[]};G(s),e({success:!0})}}if(i.type==="CAPTURE_VIDEO_CUE"){const t=Ht();if(t){const a=t.url||H(),o={id:`vid-${Date.now()}`,project:"",topic:"Video",title:t.title||"视频线索",url:a,urlType:j(a),sourcePlatform:t.sourcePlatform||"bilibili",capturedAt:new Date().toISOString(),documentType:"media",tags:t.tags||["Video"],markdownContent:t.markdownContent||"",mediaAttachments:[]};G(o),e({success:!0,item:o})}else B("当前页面未检测到视频播放器或非支持平台",!0),e({success:!1,error:"未检测到视频"});return!0}if(i.type==="PING")return e({pong:!0}),!0;if(i.type==="DETECT_PAGE_FILES"){try{const t=H(),a=Fe(document,t);e({success:!0,files:a,pageTitle:document.title,pageUrl:t})}catch(t){e({success:!1,error:t.message,files:[]})}return!0}if(i.type==="START_SCREENSHOT_CAPTURE"){const t=i.payload;return Ot((a,o)=>{G(a,o)},a=>{B(`截图失败: ${a}`,!0)},t==null?void 0:t.project,t==null?void 0:t.topics),e({success:!0}),!0}if(i.type==="CAPTURE_CHAT_SESSION"){const t=H(),a=He.findAdapter(t);if(a){const o=a.extractSession();if(o){const s={id:`session-${Date.now()}`,project:"",topic:"AI-Chat",title:o.title,url:t,urlType:j(t),sourcePlatform:a.id,capturedAt:new Date().toISOString(),documentType:"chat_session",tags:["AISession",a.name,o.modelName||"LLM"],markdownContent:o.markdown,mediaAttachments:o.mediaAttachments||[]};G(s),e({success:!0,item:s})}else B("未能识别到完整的对话轮次",!0),e({success:!1,error:"未能识别对话"})}else B("当前页面不是受支持的 AI 对话平台",!0),e({success:!1,error:"未匹配适配器"});return!0}});jt();Vt();Ft();
